...
var sortByOptions={'Best Match': 'best_match',
...
class SearchBar extends React.Component{
    ...
    //get which sort user wants
    handleSortByChange(sortByOption){
        this.setState({sortBy:sortByOption});
    }
    //get which term user input
    handleTermChange(event){
        this.setState({term:event.target.value});
        
    }
    //get which location user input
    ...
    //return views of result,change state
    renderSortByOptions(){
